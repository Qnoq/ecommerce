		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					<div class="dropdown">
						<a href="{{ route('shop.index', ['category' => request()->category, 'sort' => 'asc']) }}" class="btn">Prix croissant</a>
						<a href="{{ route('shop.index', ['category' => request()->category, 'sort' => 'desc']) }}" class="btn">Prix décroissant</a>
					</div>
